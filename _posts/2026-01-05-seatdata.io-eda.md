...
But, to add more substance to this inventory shock, I compared expiring and new listings between October 31st and November 1st. On the 31st: only 40K events expired, while the 1st had over 1M events added, with over 60% of these newly added events being Concerts! So, this presumes that November 1st served as a mark for the start of a holiday sales push for major concert tours. 
...
*Figure 15: Ticket price floor as `days_to_event` decreases*
...
*Figure 16: 1-Day sales as `days_to_event` decreases*
...
*Figure 17: Listings as `days_to_event` decreases*
