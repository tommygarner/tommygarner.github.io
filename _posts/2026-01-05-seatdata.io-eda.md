...
-  3 tiers of pricing exist in the resale market: Premium (Festivals and Theater), Mid (Concerts and Comedy), and Low (Sports) tiers
-  Tuesdays are the most volatile days of the week in resale volume, while Saturdays have the highest sales volume
-  I found five sales volume shocks that were statistically significant from similar days of the week using anomaly detection and seasonal z-scores
