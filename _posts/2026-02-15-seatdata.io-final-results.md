...
*Full notebooks, SQL, and code in the [demand_forecast repository](https://github.com/tommygarner/demand_forecast).
Try the live prediction explorer at [event-explorer.streamlit.app](https://event-explorer.streamlit.app).*
