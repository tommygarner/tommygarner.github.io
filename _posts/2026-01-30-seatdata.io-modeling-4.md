...
**Takeaways:** Threshold **0.90** minimizes RMSE in this case. Though our classifier would prefer a lower decision threshold (less confidence needed), our RMSE on predictions benefits from this greater confidence in classifications, likely because the regressor is heavily overpredicting those fringe cases!
...
**Verdict:** Optuna was the right choice. The intelligent search found better configurations 40% faster than random search would have. I was just crazy enough to run these fully to completion for 14 hours overnight to find the BEST configurations.
