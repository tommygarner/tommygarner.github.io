...
**Takeaways:** Threshold **0.80** minimizes RMSE by trading recall for precision (F1 score). We can see how the classifier lets fewer events through to the regressor as the threshold increases, wanting to be more confident in its classifications of the events.
