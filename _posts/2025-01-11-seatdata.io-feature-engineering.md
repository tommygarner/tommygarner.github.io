...
### 3.1 Outlier Clipping + Log-Scaling Prices

Before log transformation, I clipped extreme outliers at 99th percentile:
- `get_in` clipped at $900 (affected 0.67% of rows)
- `listings_median` clipped at $1,760 (affected 0.90% of rows)
...
This compressed the price range into manageable scale and prevented extreme outliers from distorting model training.
